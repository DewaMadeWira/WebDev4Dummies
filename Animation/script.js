...
code_p[cardInterval1].style.display ="block"
code_p[cardInterval2].style.display ="block"
code_p[cardInterval3].style.display ="block"
...
for (let j = 0; j < btn.length; j++) {
    btn[j].addEventListener("click", function(){
        ...
        for(let i =0; i<code_p.length; i++){
            if(i!=cardInterval1 && i!=cardInterval2 && i!=cardInterval3&& i!=cardInterval4 && i!=cardInterval5 && i!=cardInterval6 && i!=cardInterval7){
